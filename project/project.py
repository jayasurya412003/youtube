...
class sql_queries:
    ...
    def q1_allvideoname_channelname():
        gopi_s = psycopg2.connect(
            host='localhost', user='postgres', password='root', dbname='youtubee' , port='5432')
    ...
    def q3_mostviewvideos_channelname():
        gopi_s = psycopg2.connect(
            host='localhost', user='postgres', password='root', database='youtubee' , port='5432')
        cursor = gopi_s.cursor()
...
with st.sidebar:
    image_url = 'Creative Color Brushstroke Lettering Logo.png'
